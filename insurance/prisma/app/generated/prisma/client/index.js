...
exports.Prisma.PolicyHolderScalarFieldEnum = {
  id: 'id',
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\Willie\\source\\repos\\Capstone Part1\\insurance\\prisma\\app\\generated\\prisma\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\Willie\\source\\repos\\Capstone Part1\\insurance\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"app/generated/prisma/client\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel PolicyHolder {\n  id             Int                @id @default(autoincrement()) // Auto-incrementing ID\n  policyHolderId String             @unique // Unique string ID\n  email          String\n  firstName      String\n  lastName       String\n  policies       PolicyAssignment[] // Relation to PolicyAssignment\n}\n\nmodel InsurancePolicy {\n  id                Int                @id @default(autoincrement()) // Auto-incrementing ID\n  insurancePolicyId String             @unique // Unique string ID\n  name              String\n  basePriceSgd      Decimal\n  typeOfPolicy      String\n  assignments       PolicyAssignment[] // Relation to PolicyAssignment\n}\n\nmodel PolicyAssignment {\n  id                Int             @id @default(autoincrement()) // Auto-incrementing ID\n  policyHolderId    String\n  insurancePolicyId String\n  policyHolder      PolicyHolder    @relation(fields: [policyHolderId], references: [policyHolderId])\n  insurancePolicy   InsurancePolicy @relation(fields: [insurancePolicyId], references: [insurancePolicyId])\n\n  @@unique([policyHolderId, insurancePolicyId]) // Composite unique constraint\n}\n\nmodel User {\n  id            String          @id @default(cuid())\n  name          String?\n  email         String          @unique\n  emailVerified DateTime?\n  password      String?\n  image         String?\n  accounts      Account[]\n  sessions      Session[]\n  // Optional for WebAuthn support\n  Authenticator Authenticator[]\n\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n\nmodel Account {\n  userId            String\n  type              String\n  provider          String\n  providerAccountId String\n  refresh_token     String?\n  access_token      String?\n  expires_at        Int?\n  token_type        String?\n  scope             String?\n  id_token          String?\n  session_state     String?\n\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n\n  user User @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  @@id([provider, providerAccountId])\n}\n\nmodel Session {\n  sessionToken String   @unique\n  userId       String\n  expires      DateTime\n  user         User     @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  createdAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n\nmodel VerificationToken {\n  identifier String\n  token      String\n  expires    DateTime\n\n  @@id([identifier, token])\n}\n\n// Optional for WebAuthn support\nmodel Authenticator {\n  credentialID         String  @unique\n  userId               String\n  providerAccountId    String\n  credentialPublicKey  String\n  counter              Int\n  credentialDeviceType String\n  credentialBackedUp   Boolean\n  transports           String?\n\n  user User @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  @@id([userId, credentialID])\n}\n",
  "inlineSchemaHash": "a8725d10232bafb59674d56630db484e7f05e2cb366c82bdc5f0a3eeff64c39b",
  "copyEngine": true
}
